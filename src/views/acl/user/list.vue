<template>
  <div class="app-container">
    ...
    <!-- 分页器 -->
    <el-pagination :current-page="page" :total="total" :page-size="limit" :page-sizes="[3, 5, 10, 20, 30, 40, 50, 100]"
      style="padding: 20px 0; text-align: center;" layout="prev, pager, next, jumper, sizes, total"
      @current-change="getUsers" @size-change="handleSizeChange" />
    <!-- 对话框的结构 -->
